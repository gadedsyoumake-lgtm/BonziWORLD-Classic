    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                (this.userPublic = c || { name: "BonziBUDDY", color: "purple", speed: 175, pitch: 50, voice: "en-us", hat: "none" }),
               ...
               this.$container.append(
                   "\n\t\t\t<div id='bonzi_" +
                       this.id +
                       "' class='bonzi'>\n\t\t\t\t<div class='bonzi_status' style='display:none'></div><div class='bonzi_user'></span><span class='bonzi_username'></span> <span class='feeling'>(Status: "+this.userPublic.feel+")</span><i class='typing' hidden>(typing)</i></div>\n\t\t\t\t\t<div class='bonzi_placeholder'></div>\n\t\t\t\t<div style='display:none' class='bubble'>\n\t\t\t\t\t<p class='bubble-content'></p>\n\t\t\t\t<div class='close-bubble'><i class='fas fa-times' /></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t"
               ),
                            ...
                            items: {
                                ...
                                quote: {
                                    ...
                                    callback: function () {
                                        ...
                                        $("#chat_message").val("--<br><blockquote>" + d.last + "</blockquote> ").focus()
        ...
        return (
            _createClass(a, [
                    ...
                    value: function () {
                        if (allowCrossColors == true) {
                            if (this.color == "empty" && this.userPublic.color_cross != 'none') { 
                                ...
                                this.$canvas.css("background-image", `url("/img/bonzi/${this.color}.png"), url("/img/bonzi/${this.hat}.png")`);
                            }
                        ...
                        if (!warnedUserAboutHat) {
                            var warning = confirm('WARNING: You are joining a room that has a user with a hat. \n\nClick OK to allow hats, Click Cancel to disable hats.');
                            if (warning == true) {
                                    IsIHadHat = true;
                            } else {
                                IsIHadHat = false;
                            }
                            warnedUserAboutHat = true;
                        }
                ...
                },
                {
                  key: "updateFeel",
                  value: function () {
                      $(`#bonzi_`+this.id+` > .bonzi_user > .feeling`).html("(Status: "+this.userPublic.feel+")");
                  },
                },
                {
                    key: "talk",
                    value: function (a, b, c) {
                        ...
                        (c = c || !1),
                            ...
                            "undefined" != typeof b ? ((b = replaceAll(b, "{NAME}", this.userPublic.name)), (b = replaceAll(b, "{COLOR}", this.color))) : (b = a.replace("&gt;", "")),  document.getElementById("logcontent").innerHTML += "<p><font color='"+this.userPublic.color+"'>"+this.userPublic.name+": </font>"+a+"</p>",                      document.getElementById("logcontent").scrollTop = document.getElementById("logcontent").scrollHeight,
                            (a = linkify(a));
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            this.$dialogCont.html(
                                '<img src="' + a + '" style="max-width:173px;max-height:173px;width:auto;height:auto;" />'
                            ),
                                this.$dialog.show();
                        }
                    },
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            this.$dialogCont.html(
                                '<video controls autoplay style="max-width:173px;max-height:173px;width:auto;height:auto;"><source src="' + a + '" type="video/mp4"></video>'
                            ),
                                this.$dialog.show();
                        }
                    },
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            this.$dialogCont.html(
                                '<audio controls autoplay style="width:173px;"><source src="' + a + '" type="audio/mpeg"></audio>'
                            ),
                                this.$dialog.show();
                        }
                    },
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "clippy", "peedy", "green", "purple", "red", "pink", "pope", "cyan", "nazar", "empty", "yellow"], b = 0; b < a.length; b++) {
                        var c = a[b],
